...
public class EmployeeManagerTest {
    ...
    public void testRemoveEmployee() {
        ...
        assertNotEquals(employee1, employeeManager.getEmployees().getFirst());
    }
    ...
    public void testAddEmployeeWithInvalidSalary() {
        ...
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(
                new Employee("3", "Marcos Blanco", juniorDeveloper, 60000))
        );
        assertThrows(InvalidSalaryException.class, () -> employeeManager.addEmployee(
                new Employee("3", "Marcos Blanco", seniorDeveloper, 40000))
        );
    }
